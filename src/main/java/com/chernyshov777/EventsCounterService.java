 ...
 * @see EventsCounter
 */
public class EventsCounterService implements EventsCounter {

    private Deque<Long> eventsCountWithinLastMinute;
    private Deque<Long> eventsCountWithinLastHour;
    private Deque<Long> eventsCountWithinLastDay;
